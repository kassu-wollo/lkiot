        ...
        <main>
                        ...
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    <li><a class="dropdown-item" href="#">Event Listing</a></li>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">                
                ...
                <div class="offcanvas-body d-flex flex-column">
                    <img src="images/login.jpg" alt="wolo"/>
            ...
            <section class="membership-section section-padding" id="section_3">
                <div class="container">
                    ...
                    <div class="col-lg-5 col-12 mx-auto">
                        ...
                        <form action="{{route('register')}}"method="post" class="custom-form membership-form" role="form">
                                @csrf
                                                    <!-- Name -->
                                                    <div>
                                        ...
                                        <div class="flex items-center justify-end mt-4">
                                            ...
                                            <button type="reset" class="btn btn-secondary mr-2 clear-btn">Reset</button>
            ...
            <section class="contact-section section-padding" id="section_5">
                <div class="container">
                    ...
                    <div class="col-lg-5 col-12">
                        <form method="POST" action="{{url('contactpost')}}"class="custom-form contact-form" role="form">
                                @csrf
