...
@csrf
    ...
    <h1> Maker Space </h1>
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="status" id="inputEmail" type="text" placeholder="name@example.com" />
                <label for="inputEmail">Satutus</label>
            </div>
            
                    <div class="form-floating mb-3 ">
                        <input class="form-control" name="descrbition" id="inputPassword" type="text" placeholder="Create a password" />
                        <label for="inputPassword">Descrbition </label>
                    </div>
