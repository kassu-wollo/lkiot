            ...
            <section class="membership-section section-padding" id="section_3">
                <div class="container">
                    ...
                    <div class="col-lg-5 col-12 mx-auto">
                        ...
                        <form action="{{route('register')}}"method="post" class="custom-form membership-form shadow-sm" role="form">
                                @csrf
                                                    <!-- Name -->
                                                    <div>
            ...
            <section class="contact-section section-padding" id="section_5">
                <div class="container">
                    ...
                    <div class="col-lg-5 col-12">
                        <form method="POST" action="{{url('contact')}}"class="custom-form contact-form" role="form">
                                @csrf
